...
const FieldPosition: React.FC<FieldPositionProps> = ({
  ...
  return isARMode ? (
    <>
      ...
      <Circle radius={9} color="red" position={new THREE.Vector3(0, 0, -1)} />
      <Point position={new THREE.Vector3(1.2, 0.75, 1)} color="red" />
      <Point position={new THREE.Vector3(1.2, -0.5, 1)} color="red" />
      <Point position={new THREE.Vector3(1.2, -1, 1)} color="yellow" />
...
//         </Toolbar>
//       </AppBar>
//       <div ref={mountRef} id="mount" className={isARMode ? "bg-white" : ""} />
//     </div>
//   ) : (
//     <Rnd
//       size={{ width: width, height: height }}
