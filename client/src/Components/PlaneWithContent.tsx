...
const WithXRPlane = ({
  ...
  //       minusMeshRef.current.position.add(rightVector.clone().multiplyScalar(-1)); // Move left
  ...
  controllers[0].controller.addEventListener("connected", (e) => {
    // if (e.data.gamepad) {
    //   controllers[0].controller["gamepad"] = e.data.gamepad;
    // }
  });
          ...
          >
            ...
            title === `Wagonwheel` ? (
              ...
              <>
                ...
                <Html width={2} height={2} image={image} sceneSize={sceneSize}>
                  {component}
                </Html>
              </>
            )}
